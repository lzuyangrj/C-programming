...
(Table~\ref{tab:cyc} lists the $5\,\mathrm{kV}$ subset). The points
follow the $\sqrt{V}$ curve to $\le 5\%$ on the $5\,\mathrm{G}$ C2
voltages; the $10\,\mathrm{G}$ C3 fill at $5$--$8\,\mathrm{kV}$ is
coarser than a half-lobe and sits $6$--$12\%$ low. There is no free
...
spacing of $\Delta(B)$ zeros (dense $B$ scan, injection
