...
are the Virtual-IPM Block~C points on the $5\,\mathrm{kV}$ grid. The
...
model at $1\,\mathrm{kV}$ steps. Markers: Virtual-IPM. Guiding $B$ is
not scanned.}
\label{fig:iV}
\end{figure}
...
scan at that operating field: $\Delta x=+5$ and $+10\,\mathrm{mm}$
leave $\Delta$ unchanged to the line thickness
(injection $+0.61\%$, extraction $-0.11\%$). The
...
$100\,\mathrm{kW}$. (a)~$\Delta$ versus $\Delta y$ (Fine~D). Dashed:
...
$+101\%$, $+104\%$ and $+107\%$ on the same $\Delta y$ grid. Every
species and both beams agree with the drift-length law to
$0.5\%$ absolute. Panel~(b): $\Delta x=+5$ and $+10\,\mathrm{mm}$
leave every width unchanged to $0.1\%$, as required by a kick centred
on the beam and as stated for ISIS within about $10\,\mathrm{mm}$ of
the axis~\cite{Pine2006}.
