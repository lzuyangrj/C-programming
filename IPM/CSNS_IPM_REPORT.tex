...
generation (Fig.~\ref{fig:align}; $\mathrm{H}_2^+$ $+104\%$ at
$10\,\mathrm{mm}$, $100\,\mathrm{kW}$), not the v1 as-run $+33.5\%$.
...
Aligned extraction at $100\,\mathrm{kW}$ has the same fold
($\mathrm{H}_2\mathrm{O}^+$ minimum $12.7\,\mathrm{mm}$ at
$7\,\mathrm{mm}$; $\mathrm{N}_2^+$ $11.9\,\mathrm{mm}$ at
$5\,\mathrm{mm}$). The $10\,\mathrm{mm}$ design size is already on
the rising branch ($\sigma_m=14.1$ and $14.0\,\mathrm{mm}$). The I1
size grid is too coarse
($3$, $5$, $7$, $10$, $15$, $20$, $25\,\mathrm{mm}$) for a
leave-one-out invert at the $0.2\%$ injection level; a production
table should be filled at $1\,\mathrm{mm}$ in $\sigma_0$, as Block~B
already is at injection. Field-cage non-uniformity---J-PARC reported a
...
$\mathrm{N}_2^+$ invert does, at $100$--$300\,\mathrm{kW}$, provided
the ions stay inside the cage.
...
$\mathrm{N}_2^+$) recovers $\sigma_0$ to $0.2\%$ at
$100\,\mathrm{kW}$ on $\sigma_0=8$--$20\,\mathrm{mm}$, provided the
profile has not reached the wall. $\mathrm{H}_2^+$ is not used for
the size.
