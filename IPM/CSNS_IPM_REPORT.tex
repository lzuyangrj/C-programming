...
follow the $\sqrt{V}$ curve to $\le 5\%$ wherever the $B$ scan is
dense enough to interpolate the crossings, with no free parameter. That
...
Virtual-IPM points scale as $V^{-0.92}$ ($\mathrm{H}_2^+$),
$V^{-0.77}$ ($\mathrm{H}_2\mathrm{O}^+$) and $V^{-0.83}$
...
$30\,\mathrm{kV}$. Extrapolating $V^{-0.92}$ from the $25\,\mathrm{kV}$
injection point, a $10\%$ bias would require approximately
$280\,\mathrm{kV}$ across the cage, which is not a practical path. ESS
