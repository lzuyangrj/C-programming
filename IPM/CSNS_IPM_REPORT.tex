...
Table~\ref{tab:invp}). The fold moves out with power, as at
injection: near $10\,\mathrm{mm}$ at $200$--$300\,\mathrm{kW}$
and near $15\,\mathrm{mm}$ at $500\,\mathrm{kW}$. A
$10\,\mathrm{mm}$ extraction core is then at or below
$\sigma_0^*$ and is a core-versus-paint choice. The heavies
remain inside the cage at $\sigma_0\ge 10\,\mathrm{mm}$ even
at $500\,\mathrm{kW}$ (unlike injection). Commissioning I2
powers ($20$--$80$, $150$, $250\,\mathrm{kW}$) stay on the
...
Ext.\ $1.6\,\mathrm{GeV}$
  ...
  & $0$ / $0$ \\
  & $200$
  & \multicolumn{5}{l}{$1\,\mathrm{mm}$ I2 fill (see text)} \\
  & $300$
  & \multicolumn{5}{l}{$1\,\mathrm{mm}$ I2 fill (see text)} \\
  & $500$
  & \multicolumn{5}{l}{$1\,\mathrm{mm}$ I2 fill (see text)} \\
...
Invert $\sigma_m=\sigma_0\,h(\sigma_0,N,V)$
  ...
  & identify $\mathrm{H}_2\mathrm{O}^+$ or $\mathrm{N}_2^+$;
    ...
    $10\,\mathrm{mm}$ is the small (core) root;
