...
extraction ($1.6\,\mathrm{GeV}$). The recommended operating point is
...
operating size at this intensity. Panel~(b): the same identified-species
invert at $200\,\mathrm{kW}$ stays inside a few percent wherever the
profile is inside the cage (median $2.0\%$ and $1.6\%$); the fold has
moved out to $12$ and $11\,\mathrm{mm}$, so a $10\,\mathrm{mm}$ core
is then the small root and must be selected as the core, not the
paint, hypothesis. At $300\,\mathrm{kW}$ $\mathrm{N}_2^+$ is still
usable (median $2.4\%$, nine sizes). At $400$ and $500\,\mathrm{kW}$
the heavies clip
($\sigma_m\simeq 31$--$47\,\mathrm{mm}$, detected fraction
$<0.995$) and no table recovers $\sigma_0$.
...
$100$--$300\,\mathrm{kW}$. Red: $\mathrm{H}_2\mathrm{O}^+$. Green:
...
$\sigma_0\ge 6\,\mathrm{mm}$. Other I2 powers
($20$--$80$, $150$--$500\,\mathrm{kW}$) remain on the
...
Invert $\sigma_m=\sigma_0\,h(\sigma_0,N,V)$
  ...
  & identify $\mathrm{H}_2\mathrm{O}^+$ or $\mathrm{N}_2^+$;
    that peak recovers $\sigma_0$ to $0.2\%$
    (inj.\ $100\,\mathrm{kW}$, $8$--$20\,\mathrm{mm}$)
    and $0.1\%$ (aligned ext.\ $100\,\mathrm{kW}$,
    $8$--$20\,\mathrm{mm}$);
    $\mathrm{H}_2^+$ is poorly conditioned at $10\,\mathrm{mm}$;
    fails at the wall ($P\gtrsim 400\,\mathrm{kW}$) \\
\hline\hline
\end{tabular}
\end{table}
...
$0.1\%$ at aligned extraction, both at $100\,\mathrm{kW}$ on
$\sigma_0=8$--$20\,\mathrm{mm}$, provided the profile has not
reached the wall. $\mathrm{H}_2^+$ is not used for the size. The
