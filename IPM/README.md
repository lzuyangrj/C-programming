...
Replanned e-mode scans — \(B\) 0–300 G / 5 G for painted injection, extraction, and 10 mm injection at 100–500 kW; \(\sigma_x=3\)–20 mm size scans at 0/100/200/300 G and 0.1 T; a cage-voltage scan (15–35 kV) and a beam-offset check on the 10 mm beams (existing CSVs are reused, see `configs/csns_rcs_ipm/emode/README.md`):
